##  
# @page ARP_example Example code for a time dependent sequence of kicks
# 
# @subsection example6 Prototype example to illustrate a time dependent sequence
